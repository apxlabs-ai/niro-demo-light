...
from ..models import ReportRun, Role, SavedSearch, ScheduledReport, User
from ..schemas import (
    ReportRunOut,
    SavedSearchCreate,
    SavedSearchOut,
...
def disable_schedule(
    ...
    """Disable + delete a schedule. Hard-delete cascades to all ReportRun
    history via the ORM cascade rule on ScheduledReport.runs."""
