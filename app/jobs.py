...
def run_scheduled_report(report_id: int, db: Session) -> ReportRun:
    ...
    try:
        # Scope to the saved search owner so a customer's report never
        # leaks tickets belonging to other tenants. use_cache=False:
        # the worker needs a fresh result every tick.
